...
# Web form location: /workshop_management/web_form/workshop_onboarding/
# API endpoints: /workshop_management/api/onboarding_wizard.py
# Progress tracking: /workshop_management/doctype/onboarding_progress/
