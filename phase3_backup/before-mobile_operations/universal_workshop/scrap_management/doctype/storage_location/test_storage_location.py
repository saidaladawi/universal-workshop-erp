...
class TestStorageLocation(unittest.TestCase):
    ...
    def test_capacity_management(self):
        ...
        can_accommodate, reason = location.can_accommodate_part(
            part_weight=150.0, part_volume=1.0  # Exceeds max weight
        )
    ...
    def test_find_optimal_location(self):
        ...
        optimal_locations = find_optimal_location(
            part_weight=25.0, part_volume=0.5, turnover_category="Fast"
        )
    ...
    def test_location_update_usage(self):
        ...
        try:
            ...
            self.fail(f"update_current_usage failed with error: {str(e)}")
    ...
    def test_location_path_generation(self):
        ...
        child.reload()
        expected_path = f"Zone A > Aisle A1"
